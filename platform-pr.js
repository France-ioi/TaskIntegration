...
if (!isCrossDomain()) {
   ...
   (function(h) {
      h.deparam = function(i, j) {
         ...
         h.each(i.replace(/\+/g, " ").split("&"), function(i, l) {
            ...
            if (2 === a.length)
               if (a = decodeURIComponent(a[1]), j && (a = a && !isNaN(a) && parseInt(a).toString === a ? +a : "undefined" === a ? void 0 : void 0 !== k[a] ? k[a] : a), e)
                  for (; f <= e; f++)
                     c = "" === b[f] ? g.length : b[f], m = g[c] =
                             f < e ? g[c] || (b[f + 1] && isNaN(b[f + 1]) ? {} : []) : a, g = m;
               else
    ...
    */
   (function($, f) {
      var b, d, j = 1, a, g = !1, h = "postMessage", c = "addEventListener", e, i = f[h];
      $[h] = function(k, m, l) {
         if (!m) {
            return;
         }
